...
""" This function gives access to the news database by connecting
and storing it as the news_query and allows results to manipulated
in the proceeding query strings"""
...
"""This function provides the top 3 most read articles by 
building a query with the connection to news query from 
above then printing the formated results"""
...
"""This function provides the top 3 top authors per their popularity by 
building a query with the connection to news query from 
above then printing the formated results"""
...
"""This function provides a list  of the days with more than 1% errors by 
building a query with the connection to news query from 
above then printing the formated results"""
...
# This will capture the three generated queries and display them in the terminal
